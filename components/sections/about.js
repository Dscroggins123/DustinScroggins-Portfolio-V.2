    ...
    <div className="about">
      <div className="about__content">
        ...
        <p className="about__content-info">
          I’m a Full Stack Developer based in Moreno Valley, CA <span>I find joy
          experimenting with technologies to build things that live on the
          internet</span>, whether that be websites , applications, games,  or anything else
          ...
          that use them. <span>When I’m not improving my coding skills</span> or learning new
